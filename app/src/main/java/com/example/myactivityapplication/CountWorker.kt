...
class CountWorker(val context: Context, workerParameters: WorkerParameters)
    ...
    override fun doWork(): Result {
        ...
        val notification = NotificationCompat.Builder(context, App.ALERT_CHANNEL_ID)
            ...
            . setSmallIcon(R.drawable.ic_baseline_monitor_heart_24)
            . setContentIntent(pendingIntent)
            . build()

        context.getSystemService(NotificationManager::class.java).notify(WORKER_NOTIFICATION_ID, notification)
